...
class ClassifierTrainer(object):
  ...
  def train(self, X, y, X_val, y_val, 
    ...
    for it in xrange(num_iters):
      ...
      # get batch of data
      if sample_batches:
        batch_mask = np.random.choice(N, batch_size)  # random choice the number of batch_size integers in the range from 0 to N
    ...
    return best_model, loss_history, train_acc_history, val_acc_history,best_val_acc
